...
#define TOGGLE_MENU_INFO(_) \
	...
	_(DATE,      'D', "dates",             &opt.show_date, date_map, date_map_size, VIEW_NO_FLAGS), \
	_(AUTHOR,    'A', "author",            &opt.show_author, author_map, author_map_size, VIEW_NO_FLAGS), \
	_(GRAPHIC,   '~', "graphics",          &opt.line_graphics, graphic_map, graphic_map_size, VIEW_NO_FLAGS), \
	_(REV_GRAPH, 'g', "revision graph",    &opt.show_rev_graph, NULL, 0, VIEW_LOG_LIKE), \
	_(FILENAME,  '#', "file names",        &opt.show_filename, filename_map, filename_map_size, VIEW_NO_FLAGS), \
	_(FILE_SIZE, '*', "file sizes",        &opt.show_file_size, file_size_map, file_size_map_size, VIEW_NO_FLAGS), \
	_(IGNORE_SPACE, 'W', "space changes",  &opt.ignore_space, ignore_space_map, ignore_space_map_size, VIEW_DIFF_LIKE), \
	_(COMMIT_ORDER, 'l', "commit order",   &opt.commit_order, commit_order_map, commit_order_map_size, VIEW_LOG_LIKE), \
